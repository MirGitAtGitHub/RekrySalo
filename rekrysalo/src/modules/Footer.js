    ...
    width:"100%"}}>
            <div className="footer-content" style={{position:"relative"}}>
                <div className="footer-content-left" style={{position:"relative"}}>
                    <div className="footer-content-left-logo" style={{position:"relative"}}>
                        <img src={require('../images/Yrityssalo_logo.png')} alt="logo" style={{height: "20%",width: "20%",marginTop:"3%"}} />
                    </div>
                </div>
                <div className="footer-content-right" style={{position:"relative"}}>
                    <div className="footer-content-right-links" style={{position:"relative"}}>
                        <div className="footer-content-right-links-item" style={{position:"relative"}}>
                            <div class="grid-container" style={{display: "grid",columnGap: "25%",gridTemplateColumns: "auto auto auto",gridTemplateRows:"auto auto auto auto auto",position:"relative",top:"25%",right:"0%",marginBottom:"0%",marginRight:"15%"}}>
                                <div class="grid-container" style={{display: "grid",rowGap:"3%",gridTemplateColumns: "auto",gridTemplateRows:"auto auto auto auto auto",position:"relative"}}>
