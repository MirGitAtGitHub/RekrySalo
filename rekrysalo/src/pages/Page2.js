...
const Page2 = () => {
  ...
  return (
      ...
      <body className="Body">
        ...
        <div className="mid-grid">
          ...
          <div className="mid" id="mid">
            ...
            <div style={{"margin-bottom":"40px"}} onChange={() => (document.getElementById("2").checked === true) ? (document.getElementById("tpsijaintip").style.display = "",document.getElementById("optionalanswer1").style.display = "",(document.getElementById("1").checked === true && document.getElementById("ttvalinta").style.display === "none") ? document.getElementById("ttvalinta").style.display = "" : (document.getElementById("ttvalinta").style.display = "none")) : (document.getElementById("tpsijaintip").style.display = "none",document.getElementById("optionalanswer1").style.display = "none",(document.getElementById("1").checked === true && document.getElementById("ttvalinta").style.display === "none") ? document.getElementById("ttvalinta").style.display = "" : (document.getElementById("ttvalinta").style.display = "none"))}>
              <input type={"checkbox"} id="1" name="Valinta" value="1" onClick={() => (localStorage.setItem("p2etätyötaimontasijaintia",document.getElementById("1").checked),(document.getElementById("4").checked === false || (document.getElementById("4").checked === false && document.getElementById("1").checked === false)) ? (document.getElementById("lisaasijainti").style.display = "none",(itemscreate > 0) ?
    ...
    createItems(itemscreate) : "") : "")} defaultChecked={(localStorage.getItem("p2etätyötaimontasijaintia") === "true") ? true : false}></input>
              <label for="1">Etätyö tai monta sijaintia</label>
              <input type={"checkbox"} id="2" name="Valinta" value="2" onClick={() => localStorage.setItem("p2erisijainti",document.getElementById("2").checked)} defaultChecked={(localStorage.getItem("p2erisijainti") === "true") ? true : false}></input>
            ...
            <div style={{"margin-bottom":"40px",display:"none"}} id="ttvalinta">
              ...
              <input type={"checkbox"} id="4" name="Valinta" value="4" onClick={() => ((document.getElementById("4").checked === true && document.getElementById("1").checked === true && document.getElementById("ttvalinta").style.display !== "none") ? (document.getElementById("lisaasijainti").style.display = "",(itemscreate !== 0) ?
    createItems(itemscreate) : "") : (document.getElementById("lisaasijainti").style.display = "none",(itemscreate > 0) ?
    destroyItems(itemscreate) : ""),localStorage.setItem("p2montasijaintia",document.getElementById("4").checked))} defaultChecked={(localStorage.getItem("p2montasijaintia") === "true") ? true : false}></input>
